...
const char * int_to_key_name(int a) {
	...
	case GLFW_KEY_LEFT_SUPER: return "right super";
	case GLFW_KEY_RIGHT_SUPER: return "left super";
...
int keyboard_key_string_to_int(const char * a) {
	...
	else if(!strcmp(a, "escape")) return GLFW_KEY_ESCAPE;
	...
	else if(!strcmp(a, "left shift")) return GLFW_KEY_LEFT_SHIFT;
	else if(!strcmp(a, "right shift")) return GLFW_KEY_RIGHT_SHIFT;
	else if(!strcmp(a, "left ctrl")) return GLFW_KEY_LEFT_CONTROL;
	else if(!strcmp(a, "right ctrl")) return GLFW_KEY_RIGHT_CONTROL;
	else if(!strcmp(a, "left control")) return GLFW_KEY_LEFT_CONTROL;
	else if(!strcmp(a, "right control")) return GLFW_KEY_RIGHT_CONTROL;
	else if(!strcmp(a, "left alt")) return GLFW_KEY_LEFT_ALT;
	else if(!strcmp(a, "right alt")) return GLFW_KEY_RIGHT_ALT;
	...
	else if(!strcmp(a, "delete")) return GLFW_KEY_DELETE;
	else if(!strcmp(a, "page up")) return GLFW_KEY_PAGE_UP;
	else if(!strcmp(a, "page down")) return GLFW_KEY_PAGE_DOWN;
	...
	else if(!strcmp(a, "num lock")) return GLFW_KEY_NUM_LOCK;
	...
	else if(!strcmp(a, "left super")) return GLFW_KEY_LEFT_SUPER;
	else if(!strcmp(a, "right super")) return GLFW_KEY_RIGHT_SUPER;
